"""
Wichtiger Hinweis:
Dieses Programm wurde nicht von Bruno Zein erstellt.
Das Original ist unter folgendem Link abrufbar: https://github.com/Freenove/Freenove_Ultimate_Starter_Kit_for_Raspberry_Pi_Pico.
/
Important note:
This programme was not created by Bruno Zein. 
The original programme is available at the following link: https://github.com/Freenove/Freenove_Ultimate_Starter_Kit_for_Raspberry_Pi_Pico.
"""
...
class KeyPad(object):
    def __init__(self, row1: int=15, row2: int=14, row3: int=13, row4: int=12, col1: int=11, col2: int=10, col3: int=9, col4: int=8):
